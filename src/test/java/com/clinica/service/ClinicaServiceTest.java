...
class ClinicaServiceTest {
    ...
    void deveImpedirConflitoDeHorario() {
        ...
        assertFalse(agendamentoService.agendar(segunda),
                "Deve retornar false por conflito de horário");
    }
    ...
    void deveCobrarTaxaDeCancelamentoForaDoPrazo() {
        ...
        double taxa = taxaCancelamento.calcularTaxa(consulta, LocalDateTime.of(dataCancelamento, horaCancelamento));
